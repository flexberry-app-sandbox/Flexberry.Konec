...
namespace IIS.Konec
{
    ...
    public class Вольер : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Konec.ТипВольера fТипВольера;
        
        private string fПлощадь;
        
        private IIS.Konec.DetailArrayOfСоставВольера fСоставВольера;
        ...
        public virtual IIS.Konec.ТипВольера ТипВольера
        {
            get
            {
                ...
                IIS.Konec.ТипВольера result = this.fТипВольера;
        ...
        public virtual IIS.Konec.DetailArrayOfСоставВольера СоставВольера
        {
            get
            {
                ...
                {
                    this.fСоставВольера = new IIS.Konec.DetailArrayOfСоставВольера(this);
                }
                IIS.Konec.DetailArrayOfСоставВольера result = this.fСоставВольера;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВольерE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВольерE", typeof(IIS.Konec.Вольер));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ВольерL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВольерL", typeof(IIS.Konec.Вольер));
                }
            }
        }
    }
